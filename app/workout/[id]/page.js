      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-6 flex flex-col gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              type="button"
              className="inline-flex items-center gap-2 bg-[#c2f800] hover:bg-[#b2e600] text-black font-semibold text-xs sm:text-sm px-5 py-2.5 rounded-lg uppercase tracking-wider transition-all"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <button
              type="button"
              className="inline-flex items-center gap-2 bg-[#12141a] hover:bg-[#1a202c] border border-[#232936] text-white font-medium text-xs sm:text-sm px-5 py-2.5 rounded-lg uppercase tracking-wider transition-all"
            >
              <svg
                className="w-4 h-4"
                fill="none"
